...
- Cost Explorer report builder UI with date range, granularity, metric, filter, group-by, saved report selection, saved definition editing, and result preview controls.
...
- Cost Explorer-style report charts, saved report execution metadata, drilldowns, and CSV downloads.

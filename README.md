...
- Scenario JSON parsing and execution for deterministic lab setup, including packaged "First consolidated bill" and "Find the untagged data-transfer spike" scenario seeds.

...
- Scenario learner progress persistence for completed actions, current objective state, and assessment check results covering saved Cost Explorer reports, top cost drivers, cost allocation tag activation, Cost Category rules, bill reconciliation, and payment lifecycle status.
